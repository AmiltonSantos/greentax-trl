...
export class ThanksPage implements AfterViewInit {
    ...
    ngAfterViewInit() {
        this.trls = [
            `TRL1: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (${this.tituloProjeto}), proposta pela instituição (${this.instituicaoProjeto}), que tem como pesquisador responsável (${this.pesquisadorProjeto}), se encontra em “TRL 1”, em “NÍVEL 1” para Vale S.A com conceito de “PESQUISA BÁSICA”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
            ...
            `TRL2: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (${this.tituloProjeto}), proposta pela instituição (${this.instituicaoProjeto}), que tem como pesquisador responsável (${this.pesquisadorProjeto}), se encontra em “TRL 2”, em “NÍVEL 1” para Vale S.A com conceito de “PESQUISA BÁSICA”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
            ...
            `TRL3: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (${this.tituloProjeto}), proposta pela instituição (${this.instituicaoProjeto}), que tem como pesquisador responsável (${this.pesquisadorProjeto}), se encontra em “TRL 3”, em “NÍVEL 2” para Vale S.A com conceito de “PROVA DE CONCEITO”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
            ...
            `TRL4: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (${this.tituloProjeto}), proposta pela instituição (${this.instituicaoProjeto}), que tem como pesquisador responsável (${this.pesquisadorProjeto}), se encontra em “TRL 4”, em “NÍVEL 2” para Vale S.A com conceito de “PROVA DE CONCEITO”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
            ...
            `TRL5: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (${this.tituloProjeto}), proposta pela instituição (${this.instituicaoProjeto}), que tem como pesquisador responsável (${this.pesquisadorProjeto}), se encontra em “TRL 5”, em “NÍVEL 3” para Vale S.A com conceito de “PROTOTIPAÇÃO”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
            ...
            `TRL6: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (${this.tituloProjeto}), proposta pela instituição (${this.instituicaoProjeto}), que tem como pesquisador responsável (${this.pesquisadorProjeto}), se encontra em “TRL 6”, em “NÍVEL 3” para Vale S.A com conceito de “PROTOTIPAÇÃO”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
            ...
            `TRL7: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (${this.tituloProjeto}), proposta pela instituição (${this.instituicaoProjeto}), que tem como pesquisador responsável (${this.pesquisadorProjeto}), se encontra em “TRL 7”, em “NÍVEL 4” para Vale S.A com conceito de “TESTES INDUSTRIAIS/ESCALONAMENTO”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
            ...
            `TRL8: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (${this.tituloProjeto}), proposta pela instituição (${this.instituicaoProjeto}), que tem como pesquisador responsável (${this.pesquisadorProjeto}), se encontra em “TRL 8”, em “NÍVEL 4” para Vale S.A com conceito de “TESTES INDUSTRIAIS/ESCALONAMENTO”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
            ...
            `TRL9: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (${this.tituloProjeto}), proposta pela instituição (${this.instituicaoProjeto}), que tem como pesquisador responsável (${this.pesquisadorProjeto}), se encontra em “TRL 9”, em “NÍVEL 5” para Vale S.A com conceito de “FASE COMERCIAL”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
