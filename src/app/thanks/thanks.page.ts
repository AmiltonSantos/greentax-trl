...
export class ThanksPage implements AfterViewInit, OnInit {
    ...
    trl3 = `TRL3: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (SE FOR POSSÍVEL LINKAR O NOME DA TECNOLOGIA PRA APRECER), proposta pela instituição (SE FOR POSSÍVEL LINKAR O NOME DA INSTIUIÇÃO PROPONETE), que tem como pesquisador responsável (SE FOR POSSÍVEL LINKAR O NOME DO PESQUISADOR RESPONSÁVEL), se encontra em “TRL 3”, em “NÍVEL 2” para Vale S.A com conceito de “PROVA DE CONCEITO”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
    ...
    trl4 = `TRL4: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (SE FOR POSSÍVEL LINKAR O NOME DA TECNOLOGIA PRA APRECER), proposta pela instituição (SE FOR POSSÍVEL LINKAR O NOME DA INSTIUIÇÃO PROPONETE), que tem como pesquisador responsável (SE FOR POSSÍVEL LINKAR O NOME DO PESQUISADOR RESPONSÁVEL), se encontra em “TRL 4”, em “NÍVEL 2” para Vale S.A com conceito de “PROVA DE CONCEITO”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
    ...
    trl5 = `TRL5: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (SE FOR POSSÍVEL LINKAR O NOME DA TECNOLOGIA PRA APRECER), proposta pela instituição (SE FOR POSSÍVEL LINKAR O NOME DA INSTIUIÇÃO PROPONETE), que tem como pesquisador responsável (SE FOR POSSÍVEL LINKAR O NOME DO PESQUISADOR RESPONSÁVEL), se encontra em “TRL 5”, em “NÍVEL 3” para Vale S.A com conceito de “PROTOTIPAÇÃO”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
    ...
    trl6 = `TRL6: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (SE FOR POSSÍVEL LINKAR O NOME DA TECNOLOGIA PRA APRECER), proposta pela instituição (SE FOR POSSÍVEL LINKAR O NOME DA INSTIUIÇÃO PROPONETE), que tem como pesquisador responsável (SE FOR POSSÍVEL LINKAR O NOME DO PESQUISADOR RESPONSÁVEL), se encontra em “TRL 6”, em “NÍVEL 3” para Vale S.A com conceito de “PROTOTIPAÇÃO”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
    ...
    trl9 = `TRL9: Com base nos cálculos elaborados pela calculadora de maturidade tecnológica Greentax, a tecnologia analisada (SE FOR POSSÍVEL LINKAR O NOME DA TECNOLOGIA PRA APRECER), proposta pela instituição (SE FOR POSSÍVEL LINKAR O NOME DA INSTIUIÇÃO PROPONETE), que tem como pesquisador responsável (SE FOR POSSÍVEL LINKAR O NOME DO PESQUISADOR RESPONSÁVEL), se encontra em “TRL 9”, em “NÍVEL 5” para Vale S.A com conceito de “FASE COMERCIAL”. O resultado da análise é narrado a seguir, detalhando o status atual da tecnologia:
